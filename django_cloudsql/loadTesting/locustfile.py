"""
This module contains class for perform performance testing .
"""
...
class TestUser(HttpUser):
    """
        This class defines tasks to check the performance of the APIs in this project.
    """
    @task
    def create_user(self):
        """
            task create a user with random name and random username to check 
    ...
    def get_user(self):
        """
            function perform task get information of a user to check the performance of the application.
        """
        global created_user
    ...
    def delete_user(self):
        """
            this task delete a user with random user's id to check 
            the performance of the application.
        """
        ...
        if flag and len(created_user) > 1:
            ...
            response = self.client.delete(
                "http://172.23.0.3:8001/user/", json={"id": user}
            )
    ...
    def update_user(self):
        """
            this task updates information of  a user with random user's id to check the performance of the application.
        """
    ...
    def create_client(self):
        """
            this task creates a client with random name to check 
            the performance of the application.
        """
        global created_client
        global user_names_list
    ...
    def create_consignment(self):
        """
            this task creates a consignment with random name to check 
            the performance of the application.
        """
    ...
    def get_info_of_a_consignment(self):
        """
        this task checks the performance of the api which is used to get the information of a consignment.
        """
        global created_consignment
        if len(created_consignment):
            con_id = created_consignment[
                random.randint(0, len(created_consignment) - 1)
            ]
            data = {"con_id": 1}
    ...
    def get_all_consignment_of_client(self):
        """
        this task checks the performance of the api which is used to get all consignments of a client.
        """
        global created_client
        if len(created_client):
            client = created_client[random.randint(0, len(created_client) - 1)]
            ...
            response = self.client.get(
                "http://172.23.0.3:8001/consignments/", json=data
            )
            if response.status_code == 200 or response.status_code == 201:
                response_data = json.loads(response.text)
    ...
    def add_log_In_consignemnt(self):
        """
        this task checks the performance of the api which is used to add a log in a consignment.
        """
        ...
        if len(created_consignment):
            ...
            cons_id = created_consignment[
                random.randint(0, len(created_consignment) - 1)
            ]
            data = {"con_id": 1, "barcode": "Barcode10", "length": 2.3, "volume": 8.6}
    ...
    def get_info_of_a_log(self):
        """
        this task checks the performance of the api which is used to get the information of a log.
        """
        global created_log
        if len(created_log):
    ...
    def get_all_logs_of_consignment(self):
        """
        this task checks the performance of the api which is used to get the information of all logs of a consignment .
        """
        global created_consignment
        if len(created_consignment):
            cons_id = created_consignment[
    ...
    def get_users_of_client(self):
        """
        this task checks the performance of the api which is used to get the information of all users of a client .
        """
        global created_client
        if len(created_client):
            client = created_client[random.randint(0, len(created_client) - 1)]
