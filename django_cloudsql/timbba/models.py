...
class Roles(models.Model):
    ...
    def role_serializer(self):
        """
        Convert role object into dictionary.This function takes
        role object and convert into dictionary
...
class Client(models.Model):
    ...
    def client_serializer(self):
        """
            Serializer method to convert client data type to 
            dictionary.
        """
        return {
            "id": self.id,
...
class UserManager(BaseUserManager):
    """
        custome UserManager class to create custome user.
    """
    def create_user(
        self, first_name, last_name, username, email, role, phone, client, password
    ):
        """
...
class User(AbstractBaseUser):
    """
        Custome user model which inherit build in user model AbstractBaseUser 
    """
    ...
    def has_perm(self, perm, obj=None):
        """
            This method is used to check if a user has a specific permission
    ...
    def has_module_perms(self, app_label):
        """
            This method checks if a user has permissions for a given app.
        """
        return True
...
class Consignment(models.Model):
    ...
    created_by = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="created_consignments"
    )
    updated_by = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="updated_consignments"
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    ...
    def con_serializer(self):
        """
            Serializes the consignment object into a dictionary format.
            Returns:
                dict: A dictionary containing consignment details
        """
...
class Item(models.Model):
    ...
    def log_serializer(self):
        """
            ...
            Returns:
                dict: A dictionary containing log details
        """
