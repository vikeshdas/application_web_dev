"""
 File contains classes and method to handle create role operation.
"""
...
class RoleView(APIView):
    """
    View class to handle Role related operations like creating role.
    Role can be like mobile,web .mobile means user can
    ...
    def put(self, request: HttpRequest) -> JsonResponse:
        ...
        Args:
            request (HttpRequest): object of HttpRequest contains
            information of a role to save in database.
        ...
        try:
            ...
            return JsonResponse(
                {"message": "Role created successfully", "data": serialized_data},
                status=201,
                safe=False,
            )
